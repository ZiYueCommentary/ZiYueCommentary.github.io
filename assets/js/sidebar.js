...
document.writeln("										</article>");
document.writeln("										<article>");
document.writeln("											<a href='trends/中贴第三版.html' class='image'><img src='images/中文贴图模组/第二版.jpg' alt='' /></a>");
document.writeln("											<p>中文贴图模组 第三版更新<br>2022年4月1日</p>");
document.writeln("										</article>");
document.writeln("										<article>");
document.writeln("											<a href='trends/一期测试.html' class='image'><img src='images/收容失效汉化计划/一期测试.jpg' alt='' /></a>");
document.writeln("											<p>收容失效汉化计划 一期测试更新<br>2022年4月1日</p>");
document.writeln("										</article>");
