...
document.writeln("											<a href='trends/Discord群关闭.html' class='image'><img src='images/收容失效汉化计划/横幅.png' alt='' /></a>");
document.writeln("											<p>SCP - 收容失效汉化交流 Discord群关闭<br>2022年3月17日</p>");
document.writeln("										</article>");
document.writeln("										<article>");
document.writeln("											<a href='trends/汉化阶段调整.html' class='image'><img src='images/收容失效汉化计划/横幅.png' alt='' /></a>");
document.writeln("											<p>SCP - 收容失效汉化计划 汉化阶段调整<br>2022年3月13日</p>");
document.writeln("										</article>");
document.writeln("										<article>");
document.writeln("											<a href='trends/中文网站.html' class='image'><img src='images/收容失效汉化计划/中文网站.png' alt='' /></a>");
document.writeln("											<p>SCP - 收容失效 中文网站搭建完毕<br>2022年3月12日</p>");
document.writeln("										</article>");
